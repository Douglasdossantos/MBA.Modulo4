...
public class Validacoes
{
	...
	{
		if (valor == Guid.Empty) throw new DomainException(mensagem);
	}
	...
	public static void ValidarMinimoMaximos(short valor, short minimo, short maximo, string mensagem)
	{
		if (valor < minimo || valor > maximo) throw new DomainException(mensagem);
	}
	...
	public static void ValidarSeMenorQuee(short valor, short minimo, string mensagem)
	{
		if (valor < minimo) throw new DomainException(mensagem);
	}

	public static void ValidarSeMenorQuee(decimal valor, decimal minimo, string mensagem)
	{
		if (valor < minimo) throw new DomainException(mensagem);
	}


	public static void ValidarSeMenorQuee(byte valor, byte minimo, string mensagem)
	{
		if (valor < minimo) throw new DomainException(mensagem);
	}
	...
	public static void ValidarData(DateTime data, string mensagem)
	{
		if (data == default)
