...
public static class ValidacaoData
{
	...
	public static void DeveSerMenorQue<T>(DateTime dataValidacao, DateTime dataLimite, string mensagem,
	...
	public static void DeveSerMaiorQue<T>(DateTime dataMaior, DateTime dataMenor, string mensagem,
		ResultadoValidacao<T> resultado) where T : class
	{
	...
	public static void DeveTerRangeValido<T>(DateTime dataInicial, DateTime dataFinal, string mensagem,
		ResultadoValidacao<T> resultado) where T : class
	{
