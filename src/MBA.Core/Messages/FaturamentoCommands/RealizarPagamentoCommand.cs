namespace MBA.Core.Messages.FaturamentoCommands;
...
public class RealizarPagamentoCommand : CommandRaiz
{
	...
	public RealizarPagamentoCommand(Guid matriculaCursoId, Guid cursoId, Guid alunoId, bool pagamentoPodeSerRealizado,
		string nomeCurso, decimal valor, DateTime dataMatricula, DateTime? dataConclusao, string estadoMatricula,
		string numeroCartao, string nomeTitularCartao, string validadeCartao, string cvvCartao)
	{
