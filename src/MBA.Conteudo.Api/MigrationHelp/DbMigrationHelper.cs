...
namespace MBA.Conteudo.Api.MigrationHelp
{
    public static class DbMigrationHelper
    {
        ...
        private static async Task CriarCursoAsync()
        {
            ...
            curso1.AdicionarAulaSeedDeDados("1 - Fundamentos do .NET", 1, 1, "https://curso.com/aula1", new Guid("3fa85f64-5717-4562-b3fc-2c963f66afa1"));
            curso1.AdicionarAulaSeedDeDados("2 - Criando APIs REST com ASP.NET Core", 2, 2, "https://curso.com/aula2", new Guid("3fa85f64-5717-4562-b3fc-2c963f66afa2"));
            curso1.Id = new Guid("287ECA26-6E6C-457F-B6A0-69F9D1088F9A");
            ...
            curso2.AdicionarAulaSeedDeDados("1 - O que é o Manifesto Ágil e seus princípios", 1, 1, "https://curso.com/aula1", new Guid("3fa85f64-5717-4562-b3fc-2c963f66afa3"));
            curso2.AdicionarAulaSeedDeDados("2 - Como funciona o Scrum na prática", 2, 2, "https://curso.com/aula2", new Guid("3fa85f64-5717-4562-b3fc-2c963f66afa4"));
            curso2.Id = new Guid("287ECA26-6E6C-457F-B6A0-69F9D1088F9B");
            ...
            curso3.AdicionarAulaSeedDeDados("1 - Introdução à Análise de Dados", 1, 1, "https://curso.com/aula1", new Guid("3fa85f64-5717-4562-b3fc-2c963f66afa5"));
            curso3.AdicionarAulaSeedDeDados("2 - Fundamentos de SQL Server para análise", 3, 2, "https://curso.com/aula2", new Guid("3fa85f64-5717-4562-b3fc-2c963f66afa6"));
            curso3.Id = new Guid("287ECA26-6E6C-457F-B6A0-69F9D1088F9C");
